...
import whoWeAreRouter from "./routes/whoWeAreRoutes.js";
import articleRouter from "./routes/articleRoutes.js";
import productContentRouter from "./routes/productcontentRoutes.js";
...
app.use('/api/items', whoWeAreRouter);
app.use('/api/articles', articleRouter);
app.use('/api/productcontents', productContentRouter);
